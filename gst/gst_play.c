...
static volume_value = 0;
static GstElement *volume;
static void sig_add_volume(int signal);
static void sig_dec_volume(int signal);
...
void sig_add_volume(int signal)
{
	g_object_get(volume, "volume", &volume_value, NULL);
	
	g_print("add volume %d \n", volume_value);
	g_object_get(volume, "volume", ++volume_value, NULL);
}
void sig_dec_volume(int signal)
{
	g_object_get(volume, "volume", &volume_value, NULL);
	g_print("dec volume %d \n", volume_value);
	g_object_set(volume, "volume", --volume_value, NULL);
}
